...
import { Produto } from "./ecommerce/produto";
import { Carrinho } from "./ecommerce/carrinho";
...
const teclado = new Produto(250, "Teclado", []);
const mouse = new Produto(500, "Mouse", [], 0.1);
const carrinho = new Carrinho("0001", "Edson");
